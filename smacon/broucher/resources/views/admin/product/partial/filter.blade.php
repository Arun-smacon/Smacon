<div class="btn-group broucher-product">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[entity_id]" class="col-sm-2 control-label">
                                        {!! trans('broucher::product.label.entity_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[entity_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title]" class="col-sm-2 control-label">
                                        {!! trans('broucher::product.label.title')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[description]" class="col-sm-2 control-label">
                                        {!! trans('broucher::product.label.description')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[sort_order]" class="col-sm-2 control-label">
                                        {!! trans('broucher::product.label.sort_order')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[sort_order]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[categories]" class="col-sm-2 control-label">
                                        {!! trans('broucher::product.label.categories')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[categories]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[images]" class="col-sm-2 control-label">
                                        {!! trans('broucher::product.label.images')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".broucher-product .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/broucher.product.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".broucher-product .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.broucher-product .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'broucher.product.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#broucher-product-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#broucher-product-list .btn-reset-filter').css('display', 'none');
