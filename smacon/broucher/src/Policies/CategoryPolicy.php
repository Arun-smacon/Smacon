...
namespace Smacon\Broucher\Policies;

use Litepie\User\Contracts\UserPolicy;
use Smacon\Broucher\Models\Category;
...
class CategoryPolicy
{
    ...
    {
        if ($user->canDo('broucher.category.view') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        return  $user->canDo('broucher.category.create');
    }
    ...
    {
        if ($user->canDo('broucher.category.edit') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('broucher.category.verify')) {
            return true;
        }
    ...
    {
        if ($user->canDo('broucher.category.approve')) {
            return true;
        }
