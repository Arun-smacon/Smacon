...
use Smacon\Broucher\Models\Product;
...
class ProductPolicy
{
    ...
    {
        if ($user->canDo('broucher.product.view') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        return  $user->canDo('broucher.product.create');
    }
    ...
    {
        if ($user->canDo('broucher.product.edit') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('broucher.product.verify')) {
            return true;
        }
    ...
    {
        if ($user->canDo('broucher.product.approve')) {
            return true;
        }
